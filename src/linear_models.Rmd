...
=======
  html_document: default
  pdf_document: default
>>>>>>> 586680f89dd8775c1dbdfb8d45a4b6d7076bcf3a
---
...
=======
Estos datos contienen 2930 casas en la ciudad de Iowa en Estados Unidos. Los datos originales han sido modificados para facilitar uso y hacen parte del paquete [modeldata](https://modeldata.tidymodels.org/). *modeldata* hace parte de tidyverse
>>>>>>> 586680f89dd8775c1dbdfb8d45a4b6d7076bcf3a
...
=======
Usualmente es necesario dividir la informacion disponible en al menos dos conjuntos: entranamiento y prueba. Con el primer conjunto tenemos la oportunidad de ajustar los parametros del modelo. Con el segundo conjunto tenemos la posibilidad de estimar que tan bueno es el modelo cuando lo usemos en la practica.

### Particion Aleatoria

Afortundamente tidymodels tiene una funcion que nos facilita esto. Si no hay ninguna consideracion respecto a tiempo usualmente se hace una particion aleatoria de los datos disponibles. Dado que la particion es aleatoria usualmente hacemos algo que se llama *fijar la semilla* del generador de numeros aleatorios de R. Esto lo hacemos a traves de la funcion `set.seed()`. Esto nos permite reproducir los resultados nuevamente dadoq eu se escogeran las mismas muestras para entrenamiento y prueba. Tradicionalmente se usa el 80% para entrenamiento y el 20% para prueba. 
>>>>>>> 586680f89dd8775c1dbdfb8d45a4b6d7076bcf3a
...
En algunas ocasiones el tiempo hay que considerarlo debido a la naturaleza de como se genera la informacion. Miermos la distribucion de cuando se vendieron las casas
>>>>>>> 586680f89dd8775c1dbdfb8d45a4b6d7076bcf3a
